    ...
    return (
        <div className="search-result-details">
            <ul className="collapsible__list">
                ...
                <li className="collapsible__list_item"><h4>Feat: <span>{feat.feat}</span></h4></li>
                <li className="collapsible__list_item"><h4>Specific to: <span>{feat_specific ? feat_specific : "--"}</span></h4></li>
                <li className="collapsible__list_item"><h4>Skill Proficiencies: <span>{skill_proficiencies.join(", ")}</span></h4></li>
                <li className="collapsible__list_item"><h4>Tool Proficiency: <span>{tool_proficiency}</span></h4></li>
            </ul>
        </div> 
    )
}