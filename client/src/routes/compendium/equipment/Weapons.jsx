export default function Weapons(){
    return(
        <div>
            <h2>Weapons</h2>
            <p>The Weapons table in this section shows the game’s
                main weapons. The table lists the cost and weight of
                each weapon, as well as the following details:</p>
            <p><strong>Category.</strong> Every weapon falls into a category: Simple
                or Martial. Weapon proficiencies are usually
                tied to one of these categories. For example, you
                might have proficiency with Simple weapons.</p>
            <p><strong>Melee or Ranged.</strong> A weapon is classified as either
                Melee or Ranged. A Melee weapon is used to attack
                a target within 5 feet, whereas a Ranged
                weapon is used to attack at a greater distance.</p>
            <p><strong>Damage.</strong> The table lists the amount of damage a
                weapon deals when an attacker hits with it as well
                as the type of that damage.</p>
            <p><strong>Properties.</strong> Any properties a weapon has are listed
                in the Properties column. Each property is defined
                in the “Properties” section.</p>
            <p><strong>Mastery.</strong> Each weapon has a mastery property,
                which is defined in the “Mastery Properties” section.
                To use that property, you must have a feature
                that lets you use it.</p>
            <div className="compendium-content-emphasis">
                <h3>Selling Equipment</h3>
                <p>Equipment fetches half its cost when sold. In contrast,
                    trade goods and valuables—like gems and art
                    objects—retain their full value in the marketplace.
                    “Magic Items” has prices for magic items.</p>
            </div>

            <h3>Weapon Proficiency</h3>
            <div className="compendium-divider"></div>
            <p>Anyone can wield a weapon, but you must have
                ...
                is proficient with any weapon in its stat block.</p>
            
            <h3>Properties</h3>
            <div className="compendium-divider"></div>
            <p>Here are definitions of the properties in the Properties
                column of the Weapons table.</p>
            <h4>Ammunition</h4>
            <p>You can use a weapon that has the Ammunition
                ...
                rest is lost.</p>
            <h4>Finesse</h4>
            <p>When making an attack with a Finesse weapon, use
                your choice of your Strength or Dexterity modifier
                for the attack and damage rolls. You must use the
                same modifier for both rolls.</p>
            <h4>Heavy</h4>
            <p>You have Disadvantage on attack rolls with a Heavy
                weapon if it’s a Melee weapon and your Strength
                score isn’t at least 13 or if it’s a Ranged weapon and
                your Dexterity score isn’t at least 13.</p>
            <h4>Light</h4>
            <p>When you take the Attack action on your turn and
                ...
                Light weapon, and you don’t add your ability modifier
                to the extra attack’s damage unless that modifier
                is negative. For example, you can attack with a
                ...
                damage roll of the Bonus Action unless that modifier is negative.</p>
            <h4>Loading</h4>
            <p>You can fire only one piece of ammunition from a
                Loading weapon when you use an action, a Bonus
                Action, or a Reaction to fire it, regardless of the
                number of attacks you can normally make.</p>
            <h4>Range</h4>
            <p>A Range weapon has a range in parentheses after
                ...
                can’t attack a target beyond the long range.</p>
            <h4>Reach</h4>
            <p>A Reach weapon adds 5 feet to your reach when you
                attack with it, as well as when determining your
                reach for Opportunity Attacks with it.</p>
            <h4>Thrown</h4>
            <p>If a weapon has the Thrown property, you can
                ...
                use for a melee attack with that weapon.</p>
            <h4>Two-Handed</h4>
            <p>A Two-Handed weapon requires two hands when
                you attack with it.</p>
            <h4>Versatile</h4>
            <p>A Versatile weapon can be used with one or two
                hands. A damage value in parentheses appears with
                the property. The weapon deals that damage when
                used with two hands to make a melee attack.</p>

            <h3>Mastery Properties</h3>
            <div className="compendium-divider"></div>
            <p>Each weapon has a mastery property, which is usable
                only by a character who has a feature, such as
                Weapon Mastery, that unlocks the property for the
                character. The properties are defined below.</p>
            
            <div className="compendium-content-emphasis">
                <h3>Improvised Weapons</h3>
                <p>If you use an object—such as a table leg, frying pan,
                    ...
                    a Ranged weapon to make a melee attack.</p>
            </div>

            <h4>Cleave</h4>
            <p>If you hit a creature with a melee attack roll using
                ...
                extra attack only once per turn.</p>
            <h4>Graze</h4>
            <p>If your attack roll with this weapon misses a creature,
                you can deal damage to that creature equal
                ...
                increasing the ability modifier.</p>
            <h4>Nick</h4>
            <p>When you make the extra attack of the Light property,
                you can make it as part of the Attack action instead
                of as a Bonus Action. You can make this extra
                attack only once per turn.</p>
            <h4>Push</h4>
            <p>If you hit a creature with this weapon, you can push
                the creature up to 10 feet straight away from yourself
                if it is Large or smaller.</p>
            <h4>Sap</h4>
            <p>If you hit a creature with this weapon, that creature
                has Disadvantage on its next attack roll before the
                start of your next turn.</p>
            <h4>Slow</h4>
            <p>If you hit a creature with this weapon and deal
                ...
                the Speed reduction doesn’t exceed 10 feet.</p>
            <h4>Topple</h4>
            <p>If you hit a creature with this weapon, you can force
                ...
                save, the creature has the Prone condition.</p>
            <h4>Vex</h4>
            <p>If you hit a creature with this weapon and deal damage
