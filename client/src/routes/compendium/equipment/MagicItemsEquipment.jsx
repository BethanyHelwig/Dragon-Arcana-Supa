...
export default function MagicItemsEquipment(){
    return(
        <div>
            <h2>Magic Items</h2>
            <p>Adventures hold the promise—but not a guarantee—
                of finding magic items. Hundreds of magic
                items are detailed in “Magic Items” later in this document.
                Here’s what you need to know about using magic items.</p>

            <h3>Identifying a Magic Item</h3>
            <div className="compendium-divider"></div>
            <p>Some magic items are indistinguishable from their
                ...
                a magic item’s properties isn’t automatic.</p>
            <p>The Identify spell is the fastest way to reveal an
                ...
                (but not any curse the item might bear).</p>
            <p>Sometimes a magic item carries a clue to its properties.
                The command word to activate a ring might
                be etched inside the band, or a feathered design
                might hint that it’s a Ring of Feather Falling.</p>
            <p>Wearing or experimenting with an item can also
                ...
                then say you swim unexpectedly well.</p>

            <h3>Attunement</h3>
            <div className="compendium-divider"></div>
            <p>Some magic items require a creature to form a
                bond—called Attunement—with them before the
                creature can use an item’s magical properties. Without
                becoming attuned to an item that requires Attunement,
                you gain only its nonmagical benefits unless
                its description states otherwise. For example, a
                magic Shield that requires Attunement provides the
                benefits of a normal Shield if you aren’t attuned to
                it, but none of its magical properties.</p>
            <h4>Attune during a Short Rest</h4>
            <p>Attuning to an item requires you to spend a Short
                ...
                attempt fails. Otherwise, at the end of the
                Short Rest, you’re attuned to the magic item and can
                access its full magical capabilities.</p>
            <h4>No More Than Three Items</h4>
            <p>You can be attuned to no more than three magic
                ...
                more than one Ring of Protection at a time.</p>
            <h4>Ending Attunement</h4>
            <p>Your Attunement to an item ends if you no longer
                ...
                unless the item is cursed.</p>

            <h3>Wearing and Wielding Items</h3>
            <div className="compendium-divider"></div>
            <p>Using a magic item’s properties might mean wearing
                or wielding it. A magic item meant to be worn
                ...
                the shoulders. A weapon must be held.</p>
            <p>In most cases, a magic item that’s meant to be
                worn can fit a creature regardless of size or build.
                Magic garments are made to be easily adjustable, or
                they magically adjust themselves to the wearer.</p>
            <h4>Multiple Items of the Same Kind</h4>
            <p>You can’t wear more than one of certain magic
                ...
                or one cloak. The GM might make exceptions.</p>
            <h4>Paired Items</h4>
            <p>Items that come in pairs—such as boots, bracers,
                ...
                gains no benefit from either.</p>

            <h3>Magical Items A-Z</h3>
            <div className="compendium-divider"></div>
            <p>To view a list of magical items, go to the <Link to ="/compendium/magic_items" className="link--inline">Magical Items</Link> section of the Compendium.
            </p>
        </div>
    )
}