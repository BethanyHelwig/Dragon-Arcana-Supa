export default function ActivatingAMagicItem(){
    return(
        <div className="compendium-content">
            <h2>Activating a Magic Item</h2>
            <p>It usually takes a Magic action to activate a magic
                item. The item’s user might also need to do something
                special. The description of each item category
                or individual item details how an item is activated.
                Certain items use the following rules for their activation.</p>

            <h3>Command Word</h3>
            <div className="compendium-divider"></div>
            <p>A command word is a word or short phrase that
                must be spoken or signed for an item to work. Spoken
                command words must be audible and fail to
                work in areas where all sound is suppressed, as in
                the area of the Silence spell.</p>

            <h3>Consumable Items</h3>
            <div className="compendium-divider"></div>
            <p>Some items are consumed—used up, in other
                ...
                consumable item loses its magic.</p>
            <h4>Spells Cast from Items</h4>
            <p>Some magic items allow the user to cast a spell from
                the item. The spell is cast at the lowest possible
                spell and caster level, doesn’t expend any of the user’s
                spell slots, and requires no components unless
                ...
                make exceptions to these rules, changing the casting
                time, duration, or other parts of a spell.</p>
            <p>A magic item may require the user to use their
                ...
                and the user’s Proficiency Bonus applies.</p>
            <h4>Charges</h4>
            <p>Some magic items have charges that must be expended
                to activate their properties. The number
