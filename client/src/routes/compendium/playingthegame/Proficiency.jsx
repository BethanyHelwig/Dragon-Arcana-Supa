export default function Proficiency(){
        ...
        <div className="compendium-content">
            <h2>Proficiency</h2>
            <p>Characters and monsters are good at various
                things. Some are skilled with many weapons, while
                others can use only a few. Some are better at understanding
                people’s motives, and others are better at
                unlocking the secrets of the multiverse. All creatures
                have a Proficiency Bonus, which reflects the
                impact that training has on the creature’s capabilities.
                A character’s Proficiency Bonus increases as
                ...
                determined.</p>
            <p>This bonus is applied to a D20 Test when the creature
            ...
            <p>Your Proficiency Bonus can’t be added to a die roll
                ...
                it twice if you’re proficient in both skills.</p>
            <p>Occasionally, a Proficiency Bonus might be multiplied
                or divided (doubled or halved, for example)
                before being added. For example, the Expertise
                feature (see “Rules Glossary”) doubles the Proficiency
                Bonus for certain ability checks. Whenever
                the bonus is used, it can be multiplied only once and
                divided only once.</p>

            <h3>Skill Proficiencies</h3>
            <p>Most ability checks involve using a skill, which represents
                ...
                on whether a skill is relevant in a situation.</p>
            <p>If a creature is proficient in a skill, the creature
                applies its Proficiency Bonus to ability checks involving
                that skill. Without proficiency in a skill, a
            ...
            <h4>Skill List</h4>
            <p>The skills are shown on the Skills table, which notes
                example uses for each skill proficiency as well as
                the ability check the skill most often applies to.</p>
            <h4>Determining Skills</h4>
            <p>A character’s starting skill proficiencies are determined
                at character creation, and a monster’s skill
                proficiencies appear in its stat block.</p>

            <h3>Saving Throw Proficiencies</h3>
            <div className="compendium-divider"></div>
            <p>Proficiency in a saving throw lets a character add
                ...
                throw proficiencies, as noted in their stat blocks.</p>
            <p>Each class gives proficiency in at least two saving
                ...
                they train to resist mental assault.</p>

            <h3>Equipment Proficiencies</h3>
            <div className="compendium-divider"></div>
            <p>A character gains proficiency with various weapons
                and tools from their class and background. There
                are two categories of equipment proficiency:</p>
            <p><strong>Weapons.</strong> Anyone can wield a weapon, but proficiency
                makes you better at wielding it. If you have
                proficiency with a weapon, you add your Proficiency
                Bonus to attack rolls you make with it.</p>
            <p><strong>Tools.</strong> If you have proficiency with a tool, you can
                ...
                tool proficiency on the same ability check.</p>
        </div>
    )
}