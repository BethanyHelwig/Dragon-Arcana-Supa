export default function Actions(){
        ...
        <div className="compendium-content">
            <h2>Actions</h2>
            <p>When you do something other than moving or communicating,
                you typically take an action. The Action
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Dodge</td>
                        <td>Until the start of your next turn, attack rolls against you have Disadvantage, and
                    ...
                    <tr>
                        <td>Influence</td>
                        <td>Make a Charisma (Deception, Intimidation, Performance, or Persuasion) or Wisdom
                            (Animal Handling) check to alter a creature’s attitude.</td>
                    </tr>
                    <tr>
                        <td>Magic</td>
            ...
            <p>The game uses actions to govern how much you can
                do at one time. You can take only one action at a
                time. This principle is most important in combat, as
                explained in “Combat” later in “Playing the Game.”</p>
            <p>Actions can come up in other situations, too: in a
                ...
                the Utilize action).</p>

            <h3>Bonus Actions</h3>
            <p>Various class features, spells, and other abilities let
                ...
                don’t have a Bonus Action to take.</p>
            <p>You can take only one Bonus Action on your turn,
                so you must choose which Bonus Action to use if you
                have more than one available.</p>
            <p>You choose when to take a Bonus Action during
                your turn unless the Bonus Action’s timing is specified.
                Anything that deprives you of your ability to
                take actions also prevents you from taking a Bonus Action.</p>

            <h3>Reactions</h3>
            <p>Certain special abilities, spells, and situations allow
                ...
                “Playing the Game,” is the most common type of Reaction.</p>
            <p>When you take a Reaction, you can’t take another
                one until the start of your next turn. If the reaction
                interrupts another creature’s turn, that creature
                can continue its turn right after the Reaction.</p>
            <p>In terms of timing, a Reaction takes place immediately
