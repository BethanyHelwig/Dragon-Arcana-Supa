export default function SocialInteraction(){
        ...
        <div className="compendium-content">
            ...
            <p>During their adventures, player characters meet
                ...
                characters who are participating.</p>
            <p>An NPC’s attitude toward your character is
                Friendly, Indifferent, or Hostile, as defined in “Rules
                Glossary.” Friendly NPCs are predisposed to help,
                and Hostile ones are inclined to hinder.</p>
            <p>Social interactions progress in two ways: through
                roleplaying and ability checks.</p>

            <h3>Roleplaying</h3>
            <div className="compendium-divider"></div>
            <p>Roleplaying is, literally, the act of playing out a role.
                ...
                fore during social interactions.</p>
            <p>As you roleplay, consider whether you prefer an
                active approach or a descriptive approach.</p>
            <p>The GM uses an NPC’s personality and your character’s
                ...
                dragon laps up flattery.</p>
            <p>When interacting with an NPC, pay attention to
                the GM’s portrayal of the NPC’s personality. You
                might be able to learn an NPC’s goals and then use
                that information to influence the NPC.</p>
            <p>If you offer NPCs something they want or play
                ...
                efforts to convince or deceive will likely fail.</p>
            
            <h3>Ability Checks</h3>
            <div className="compendium-divider"></div>
            <p>Ability checks can be key in determining the outcome
                ...
                take the Influence action.</p>
            <p>Pay attention to your skill proficiencies when
                thinking of how you will interact with an NPC; use
                an approach that relies on your group’s skill proficiencies.
                For example, if the group needs to trick
