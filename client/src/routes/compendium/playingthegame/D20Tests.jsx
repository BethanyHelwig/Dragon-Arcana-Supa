export default function D20Tests(){
        return (
        <div className="compendium-content">
            <h2>D20 Tests</h2>
            <p>When the outcome of an action is uncertain, the
                game uses a d20 roll to determine success or failure.
                These rolls are called D20 Tests, and they come
                in three kinds: ability checks, saving throws, and
                attack rolls. They follow these steps:
            </p>
            <ul>
                <li><strong>Roll 1d20.</strong> You always want to roll high. If the
                    roll has Advantage or Disadvantage (described
                    later in “Playing the Game”), you roll two d20s,
                    but you use the number from only one of them—
                    the higher one if you have Advantage or the lower
                    one if you have Disadvantage.</li>
                <li><strong>Add Modifiers.</strong> Add these modifiers to the number
                    rolled on the d20:
                    <ul>
                        <li><strong>The Relevant Ability Modifier.</strong> “Playing the
                            Game” and “Rules Glossary” explain which ability
                            modifiers to use for various D20 Tests.</li>
                        <li><strong>Your Proficiency Bonus If Relevant.</strong> Each creature
                            ...
                            See “Proficiency” later in “Playing the
                            Game.”</li>
                        <li><strong>Circumstantial Bonuses and Penalties.</strong> A class
                            feature, a spell, or another rule might give a bonus
                            or penalty to the die roll.</li>
                    </ul>
                </li>
                <li><strong>Compare the Total to a Target Number.</strong> If the
                    ...
                    ability check or a saving throw is called a Difficulty
                    Class (DC). The target number for an attack
            ...
            <p>An ability check represents a creature using talent
                and training to try to overcome a challenge, such as
                forcing open a stuck door, picking a lock, entertaining
                a crowd, or deciphering a cipher. The GM and the
                ...
                uncertain and narratively interesting, the dice determine
                the result.</p>
            <h4>Ability Modifier</h4>
            <p>An ability check is named for the ability modifier it
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th scope="col">Make a Check To...</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <p>Add your Proficiency Bonus to an ability check
                when the GM determines that a skill or tool proficiency
                ...
                information about skill and tool proficiencies.</p>
            <h4>Difficulty Class</h4>
            <p>The Difficulty Class of an ability check represents
                the task’s difficulty. The more difficult the task,
                the higher its DC. The rules provide DCs for certain
                checks, but the GM ultimately sets them. The Typical
            ...
            <h3>Saving Throws</h3>
            <div className="compendium-divider"></div>
            <p>A saving throw—also called a save—represents an
                ...
                or a monster (if you’re the GM) is at risk. A
                save’s result is detailed in the effect that caused it.</p>
            <p>If you don’t want to resist the effect, you can
                choose to fail the save without rolling.</p>
            <h4>Ability Modifier</h4>
            <p>Saving throws are named for the ability modifiers
            ...
            <table>
                <thead>
                    <tr>
                        <th scope="col">Ability</th>
                        <th scope="col">Make a Save To ...</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <h4>Proficiency Bonus</h4>
            <p>You add your Proficiency Bonus to your saving
                throw if you have proficiency in that kind of save.
                See “Proficiency” later in “Playing the Game.”</p>

            <h4>Difficulty Class</h4>
            <p>The Difficulty Class for a saving throw is determined
                by the effect that causes it or by the GM. For
                ...
                for saves specify the DC.</p>

            <h3>Attack Rolls</h3>
            <div className="compendium-divider"></div>
            <p>An attack roll determines whether an attack hits
                a target. An attack roll hits if the roll equals or
                exceeds the target’s Armor Class. Attack rolls usually
                occur in battle, described in “Combat” later in
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Varies</td>
                        <td>Spell attack (the ability used is determined
                            by the spellcaster’s spellcasting feature, as
                            explained in “Spells”)</td>
                    </tr>
                </tbody>
            </table>
            <p>Some features let you use different ability modifiers
                from those listed. For example, the Finesse property
                (see “Equipment”) lets you use Strength or Dexterity
                with a weapon that has that property.</p>
            <h4>Proficiency Bonus</h4>
            <p>You add your Proficiency Bonus to your attack roll
                ...
                more information about weapon proficiencies.</p>
            <h4>Armor Class</h4>
            <p>A creature’s Armor Class represents how well the
                ...
                monster appears in its stat block.</p>
            <p><strong>Calculating AC.</strong> All creatures start with the same base AC calculation:</p>
            <p><strong>Base AC</strong> = 10 + the creature’s Dexterity modifier</p>
            <p>A creature’s AC can then be modified by armor, magic items, spells, and more.</p>
            <p><strong>Only One Base AC.</strong> Some spells and class features
                give characters a different way to calculate their AC.
                A character with multiple features that give different
                ways to calculate AC must choose which one to
                use; only one base calculation can be in effect for a
                creature.</p>
            <h4>Rolling 20 or 1</h4>
            <p>If you roll a 20 on the d20 (called a “natural 20”) for
                an attack roll, the attack hits regardless of any modifiers
                or the target’s AC. This is called a Critical Hit
                (see “Combat” later in “Playing the Game”).</p>
            <p>If you roll a 1 on the d20 (a “natural 1”) for an attack
                roll, the attack misses regardless of any modifiers
                or the target’s AC.</p>

            <h3>Advantage/Disadvantage</h3>
            <div className="compendium-divider"></div>
            <p>Sometimes a D20 Test is modified by Advantage or
                Disadvantage. Advantage reflects the positive circumstances
                surrounding a d20 roll, while Disadvantage
                reflects negative circumstances.</p>
            <p>You usually acquire Advantage or Disadvantage
                through the use of special abilities and actions. The GM can also decide 
                that circumstances grant Advantage or impose Disadvantage.</p>
            <div className="compendium-content-emphasis">
                <h3>Heroic Inspiration</h3>
                <p>Sometimes the GM or a rule gives you Heroic Inspiration.
                    If you have Heroic Inspiration, you can expend it
                    to reroll any die immediately after rolling it, and you
                    must use the new roll.</p>
                <p><strong>Only One at a Time.</strong> You can never have more
                    ...
                    who lacks it.</p>
                <p><strong>Gaining Heroic Inspiration.</strong> Your GM can
                    give you Heroic Inspiration for a variety of reasons.
                    Typically, GMs award it when you do something particularly
                    heroic, in character, or entertaining. It’s a
                    reward for making the game more fun for everyone
                    playing.</p>
                <p>Other rules might allow your character to gain
                    Heroic Inspiration independent of the GM’s decision.
                    For example, Human characters start each day with
                    Heroic Inspiration.</p>   
            </div>
            <h4>Roll Two D20s</h4>
            <p>When a roll has either Advantage or Disadvantage,
                ...
                those numbers, use the 18.</p>
            <h4>They Don’t Stack</h4>
            <p>If multiple situations affect a roll and they all grant
                Advantage on it, you still roll only two d20s. Similarly,
                if multiple situations impose Disadvantage on
                a roll, you roll only two d20s.</p>
            <p>If circumstances cause a roll to have both Advantage
                ...
                you have neither Advantage nor Disadvantage.</p>
            <h4>Interactions with Rerolls</h4>
            <p>When you have Advantage or Disadvantage and
                something in the game lets you reroll or replace the
                d20, you can reroll or replace only one die, not both.
                You choose which one.</p>
            <p>For example, if you have Heroic Inspiration (see
                the sidebar below) and roll a 3 and an 18 on an ability
                check that has Advantage or Disadvantage, you
                could expend your Heroic Inspiration to reroll one
                of those dice, not both of them.</p>
        </div>
    )
}