export default function Exploration(){
        ...
        <div className="compendium-content">
            <h2>Exploration</h2>
            <p>Exploration involves delving into places that are
                dangerous and full of mystery. The rules in this section
                detail some of the ways adventurers interact
                with the environment in such places.</p>

            <h3>Adventuring Equipment</h3>
            <div className="compendium-divider"></div>
            <p>As adventurers explore, their equipment can help
                ...
                pursuers with Caltrops.</p>
            <p>See “Equipment” for rules on many items that are
                ...
                you’re reluctant to touch.</p>

            <h3>Vision and Light</h3>
            <div className="compendium-divider"></div>
            <p>Some adventuring tasks—such as noticing danger,
                hitting an enemy, and targeting certain spells—are
                affected by sight, so effects that obscure vision can
                hinder you, as explained below.</p>
            <h4>Obscured Areas</h4>
            <p>An area might be Lightly or Heavily Obscured. In a
                ...
                rely on sight.</p>
            <p>A Heavily Obscured area—such as an area with
                Darkness, heavy fog, or dense foliage—is opaque.
                You have the Blinded condition (see “Rules Glossary”)
                when trying to see something there.</p>
            <h4>Light</h4>
            <p>The presence or absence of light determines the category
                of illumination in an area, as defined below.</p>
            <p><strong>Bright Light.</strong> Bright Light lets most creatures see
                normally. Even gloomy days provide Bright Light, as
                do torches, lanterns, fires, and other sources of illumination
                within a specific radius.</p>
            <p><strong>Dim Light.</strong> Dim Light, also called shadows, creates
                a Lightly Obscured area. An area of Dim Light
                ...
                bathe the land in Dim Light.</p>
            <p><strong>Darkness.</strong> Darkness creates a Heavily Obscured
                area. Characters face Darkness outdoors at night
                (even most moonlit nights), within the confines of
                an unlit dungeon, or in an area of magical Darkness.</p>
            <h4>Special Senses</h4>
            <p>Some creatures have special senses that help them
                perceive things in certain situations. “Rules Glossary”
                defines the following special senses:</p>
            <ul>
                <li>Blindsight</li>
                <li>Darkvision</li>
                <li>Tremorsense</li>
            ...
            <h3>Hiding</h3>
            <div className="compendium-divider"></div>
            <p>Adventurers and monsters often hide, whether to
                spy on one another, sneak past a guardian, or set an
                ambush. The Game Master decides when circumstances
                are appropriate for hiding. When you try to
                hide, you take the Hide action.</p>

            <h3>Interacting with Objects</h3>
            <div className="compendium-divider"></div>
            <p>Interacting with objects is often simple to resolve.
                The player tells the GM that their character is doing
                something, such as moving a lever or opening
                a door, and the GM describes what happens. Sometimes,
                however, rules govern what you can do with
                an object, as detailed in the following sections.</p>
            <h4>What Is an Object?</h4>
            <p>For the purpose of the rules, an object is a discrete,
                inanimate item like a window, door, sword, book,
                table, chair, or stone. It isn’t a building or a vehicle,
                which are composed of many objects.</p>
            <h4>Time-Limited Object Interactions</h4>
            <p>When time is short, such as in combat, interactions
                ...
                “Combat” later in “Playing the Game.”</p>
            <h4>Finding Hidden Objects</h4>
            <p>When your character searches for hidden things,
                ...
                other important details, or both.</p>
            <p>If you describe your character searching nowhere
                near a hidden object, a Wisdom (Perception) check
                won’t reveal the object, no matter the check’s total.</p>
            <h4>Carrying Objects</h4>
            <p>You can usually carry your gear and treasure without
                ...
                “Rules Glossary.”</p>
            <h4>Breaking Objects</h4>
            <p>As an action, you can automatically break or otherwise
                ...
                the rules on breaking objects in “Rules Glossary.”</p>

            <div className="compendium-content-emphasis">
                <h3>Marching Order</h3>
                <p>The adventurers should establish a marching order
                    ...
                    or arrange miniatures to show it.</p>
            </div>

            <h3>Hazards</h3>
            <div className="compendium-divider"></div>
            <p>Monsters are the main perils characters face, but
            ...
            <h3>Travel</h3>
            <div className="compendium-divider"></div>
            <p>During an adventure, the characters might travel
                ...
                GM might have you use the travel pace rules below.</p>
            <p>If you need to know how fast you can move when
                every second matters, see the movement rules in
                “Combat” later in “Playing the Game.”</p>
            <h4>Travel Pace</h4>
            <p>While traveling outside combat, a group can move
            ...
            <p>Each travel pace has a game effect, as defined below.</p>
            <p><strong>Fast.</strong> Traveling at a Fast pace imposes Disadvantage
                on a traveler’s Wisdom (Perception or Survival)
                and Dexterity (Stealth) checks.</p>
            <p><strong>Normal.</strong> Traveling at a Normal pace imposes Disadvantage on Dexterity (Stealth) checks.</p>
            <p><strong>Slow.</strong> Traveling at a Slow pace grants Advantage on Wisdom (Perception or Survival) checks.</p>
            <h4>Vehicles</h4>
            <p>Travelers in wagons, carriages, or other land vehicles
                ...
                able to travel for up to 24 hours per day. “Equipment”
                includes vehicles for sale.</p>
        </div>
    )
}