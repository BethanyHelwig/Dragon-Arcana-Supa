export default function Combat(){
        ...
        <div className="compendium-content">
            ...
            <p>A typical combat encounter is a clash between two
                ...
                next round if neither side is defeated.</p>
            <h4>Combat Step by Step</h4>
            <p>Combat unfolds in these steps:</p>
            <ol>
                <li><strong>Establish Positions.</strong> The Game Master determines
                    ...
                    the GM figures out where the adversaries
                    are—how far away and in what direction.</li>
                <li><strong>Roll Initiative.</strong> Everyone involved in the combat
                    encounter rolls Initiative, determining the order
                    of combatants’ turns.</li>
                <li><strong>Take Turns.</strong> Each participant in the battle takes
                    a turn in Initiative order. When everyone involved
                    in the combat has had a turn, the round
                    ends. Repeat this step until the fighting stops.</li>
            </ol>
            <h4>Initiative</h4>
            <p>Initiative determines the order of turns during
                ...
                GM rolls for monsters. For a group of identical creatures,
                the GM makes a single roll, so each member of
                the group has the same Initiative.</p>
            <p><strong>Surprise.</strong> If a combatant is surprised by combat
                ...
                that combat is starting, that foe is surprised.</p>
            <p><strong>Initiative Order.</strong> A combatant’s check total is
                ...
                same from round to round.</p>
            <p><strong>Ties.</strong> If a tie occurs, the GM decides the order
                among tied monsters, and the players decide the
                order among tied characters. The GM decides the
                order if the tie is between a monster and a player character.</p>
            <h4>Your Turn</h4>
            <p>On your turn, you can move a distance up to your
                Speed and take one action. You decide whether to
                move first or take your action first.</p>
            <p>The main actions you can take are listed in “Actions”
                earlier in “Playing the Game.” A character’s
                features and a monster’s stat block also provide
                action options. “Movement and Position” later in
                “Playing the Game” gives the rules for movement.</p>
            <p><strong>Communicating.</strong> You can communicate however
                you are able—through brief utterances and gestures—
                as you take your turn. Doing so uses neither
                your action nor your move.</p>
            <p>Extended communication, such as a detailed explanation
                of something or an attempt to persuade a
                foe, requires an action. The Influence action is the
                main way you try to influence a monster.</p>
            <p><strong>Interacting with Things.</strong> You can interact with
                ...
                toward a foe.</p>
            <p>If you want to interact with a second object, you
                need to take the Utilize action. Some magic items
                and other special objects always require an action
                to use, as stated in their descriptions.</p>

            <div className="compendium-content-emphasis">
                <h3>Playing on a Grid</h3>
                <p>If you play using a square grid and miniatures or other tokens, follow these rules.</p>
                <p><strong>Squares.</strong> Each square represents 5 feet.</p>
                <p><strong>Speed.</strong> Rather than moving foot by foot, move
                    ...
                    30 feet translates into 6 squares. If you use a grid often,
                    consider writing your Speed in squares on your
                    character sheet.</p>
                <p><strong>Entering a Square.</strong> To enter a square, you must
                    ...
                    square cost even more.</p>
                <p><strong>Corners.</strong> Diagonal movement can’t cross the corner
                    of a wall, a large tree, or another terrain feature
                    that fills its space.</p>
                <p><strong>Ranges.</strong> To determine the range on a grid between
                    two things—whether creatures or objects—
                    count squares from a square adjacent to one of them
                    and stop counting in the space of the other one.
                    Count by the shortest route.</p>
            </div>
            <p>The GM might require you to use an action for
                ...
                drawbridge.</p>
            <p><strong>Doing Nothing on Your Turn.</strong> You can forgo moving,
                ...
                to delay acting.</p>
            <h4>Ending Combat</h4>
            <p>Combat ends when one side or the other is defeated,
                which can mean the creatures are killed or knocked
                out or have surrendered or fled. Combat can also
                end when both sides agree to end it.</p>

            <h3>Movement and Position</h3>
            <p>On your turn, you can move a distance equal to your Speed or less. Or you can decide not to move.</p>
            <p>Your movement can include climbing, crawling,
                ...
                can constitute your entire move.</p>
            <p>However you’re moving with your Speed, you
                deduct the distance of each part of your move from
                it until it is used up or until you are done moving,
                whichever comes first.</p>
            <p>A character’s Speed is determined during character
                ...
                a Climb Speed, Fly Speed, or Swim Speed.</p>
            <h4>Difficult Terrain</h4>
            <p>Combatants are often slowed down by Difficult
                Terrain. Low furniture, rubble, undergrowth, steep
                stairs, snow, and shallow bogs are examples of Difficult Terrain.</p>
            <p>Every foot of movement in Difficult Terrain costs
                1 extra foot, even if multiple things in a space count
                as Difficult Terrain.</p>
            <h4>Breaking Up Your Move</h4>
            <p>You can break up your move, using some of its
                movement before and after any action, Bonus Action,
                or Reaction you take on the same turn. For
                example, if you have a Speed of 30 feet, you could go
                10 feet, take an action, and then go 20 feet.</p>
            <h4>Dropping Prone</h4>
            <p>On your turn, you can give yourself the Prone condition
                (see “Rules Glossary”) without using an action
                or any of your Speed, but you can’t do so if your Speed is 0.</p>
            <h4>Creature Size</h4>
            <p>A creature belongs to a size category, which determines
                ...
                and the area it needs to fight effectively.</p>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th scope="col">Space (Feet)</th>
                        <th scope="col">Space (Squares)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <p>During your move, you can pass through the space
                of an ally, a creature that has the Incapacitated
                condition (see “Rules Glossary”), a Tiny creature, or
                a creature that is two sizes larger or smaller than you.</p>
            <p>Another creature’s space is Difficult Terrain for
                you unless that creature is Tiny or your ally.</p>
            <p>You can’t willingly end a move in a space occupied
                ...
                or are of a larger size than the other creature.</p>

            <h3>Making an Attack</h3>
            <p>When you take the Attack action, you make an
            ...
            <ol>
                ...
                <li><strong>Determine Modifiers.</strong> The GM determines
                    ...
                    or bonuses to your attack roll.</li>
                <li><strong>Resolve the Attack.</strong> Make the attack roll, as
                    ...
                    cause special effects in addition to or instead of damage.</li>
            </ol>

            <div className="compendium-content-emphasis">
                <h3>Unseen Attackers and Targets</h3>
                <p>When you make an attack roll against a target you
                    ...
                    target isn’t in the location you targeted, you miss.</p>
                <p>When a creature can’t see you, you have Advantage
                    on attack rolls against it.</p>
                <p>If you are hidden when you make an attack roll,
                    you give away your location when the attack hits or misses.</p>
            </div>

            <h3>Cover</h3>
            <p>Walls, trees, creatures, and other obstacles can provide
                cover, making a target more difficult to harm.
                As detailed in the Cover table, there are three degrees
                of cover, each of which gives a different benefit
                to a target.</p>
            <p>A target can benefit from cover only when an attack
                ...
                applies; the degrees aren’t added together. For example,
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th scope="col">Benefit to Target</th>
            ...
            <p>Some ranged attacks, such as those made with a
                ...
                a target beyond long range.</p>
            <h4>Ranged Attacks in Close Combat</h4>
            <p>Aiming a ranged attack is more difficult when a foe
                ...
                the Incapacitated condition (see “Rules Glossary”).</p>

            <h3>Melee Attacks</h3>
            <div className="compendium-divider"></div>
            <p>A melee attack allows you to attack a target within
                your reach. A melee attack typically uses a handheld
                weapon or an Unarmed Strike. Many monsters
                make melee attacks with claws, teeth, or other body
                parts. A few spells also involve melee attacks.</p>
            <h4>Reach</h4>
            <p>A creature has a 5-foot reach and can thus attack
                targets within 5 feet when making a melee attack.
                Certain creatures have melee attacks with a reach
                greater than 5 feet, as noted in their descriptions.</p>
            <h4>Opportunity Attacks</h4>
            <p>Combatants watch for enemies to drop their guard.
                If you move heedlessly past your foes, you put yourself
                in danger by provoking an Opportunity Attack.</p>
            <p><strong>Avoiding Opportunity Attacks.</strong> You can avoid
                provoking an Opportunity Attack by taking the
                Disengage action. You also don’t provoke an Opportunity
                Attack when you Teleport or when you are
                ...
                of a foe’s reach or if you fall past an enemy.</p>
            <p><strong>Making an Opportunity Attack.</strong> You can make an
                Opportunity Attack when a creature that you can
                see leaves your reach. To make the attack, take a Reaction
                to make one melee attack with a weapon or
                an Unarmed Strike against that creature. The attack
                occurs right before it leaves your reach.</p>

            <h3>Mounted Combat</h3>
            <div className="compendium-divider"></div>
            <p>A willing creature that is at least one size larger
                than a rider and that has an appropriate anatomy
                can serve as a mount, using the following rules.</p>
            <h4>Mounting and Dismounting</h4>
            <p>During your move, you can mount a creature that
                ...
                you spend 15 feet of movement to mount a horse.</p>
            <h4>Controlling a Mount</h4>
            <p>You can control a mount only if it has been trained
                to accept a rider. Domesticated horses, mules, and
                similar creatures have such training.</p>
            <p>The Initiative of a controlled mount changes to
                ...
                turn that you mount it.</p>
            <p>In contrast, an independent mount—one that lets
                you ride but ignores your control—retains its place
                in the Initiative order and moves and acts as it likes.</p>
            <h4>Falling Off</h4>
            <p>If an effect is about to move your mount against its
                will while you’re on it, you must succeed on a DC 10
                Dexterity saving throw or fall off, landing with the
                Prone condition (see “Rules Glossary”) in an unoccupied
                space within 5 feet of the mount.</p>
            <p>While mounted, you must make the same save if
                you’re knocked Prone or the mount is.</p>

            <h3>Underwater Combat</h3>
            <div className="compendium-divider"></div>
            <p>A fight underwater follows these rules.</p>
            <h4>Impeded Weapons</h4>
            <p>When making a melee attack roll with a weapon
                underwater, a creature that lacks a Swim Speed has
                Disadvantage on the attack roll unless the weapon
                deals Piercing damage.</p>
            <p>A ranged attack roll with a weapon underwater
                automatically misses a target beyond the weapon’s
                normal range, and the attack roll has Disadvantage
                against a target within normal range.</p>
            <h4>Fire Resistance</h4>
            <p>Anything underwater has Resistance to Fire damage
                (explained in “Damage and Healing”).</p>
        </div>
    )
}