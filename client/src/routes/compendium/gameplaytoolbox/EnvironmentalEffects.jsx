export default function EnvironmentalEffects(){
    return (
        <div className="compendium-content">
            ...
            <p>Swimming through deep water (more than 100 feet
                ...
                lacks a Swim Speed must succeed on a DC 10 Constitution
                saving throw or gain 1 Exhaustion level.</p>

            <h3>Extreme Cold</h3>
            <div className="compendium-divider"></div>
            <p>When the temperature is 0 degrees Fahrenheit or
                ...
                damage automatically succeed on the save.</p>

            <h3>Extreme Heat</h3>
            <div className="compendium-divider"></div>
            <p>When the temperature is 100 degrees Fahrenheit or
                ...
                Disadvantage on the save. Creatures that have Resistance
                or Immunity to Fire damage automatically
                succeed on the save.</p>

            <h3>Frigid Water</h3>
            <div className="compendium-divider"></div>
            <p>A creature can be immersed in frigid water for a
                ...
                or Immunity to Cold damage automatically succeed
                on the save, as do creatures that are naturally
                adapted to living in ice-cold water.</p>

            <h3>Heavy Precipitation</h3>
            <div className="compendium-divider"></div>
            <p>Everything within an area of heavy rain or heavy
                snowfall is Lightly Obscured, and creatures in the
                area have Disadvantage on all Wisdom (Perception)
                checks. Heavy rain also extinguishes open flames.</p>

            <h3>High Altitude</h3>
            <div className="compendium-divider"></div>
            <p>Traveling at altitudes of 10,000 feet or higher above
                ...
                that creature can travel (see “Travel Pace”).</p>
            <p>Creatures can become acclimated to a high altitude
                by spending 30 days or more at this elevation.
            ...
            <h3>Slippery Ice</h3>
            <div className="compendium-divider"></div>
            <p>Slippery ice is Difficult Terrain. A creature that
                moves onto slippery ice for the first time on a turn
                or starts its turn there must succeed on a DC 10
                Dexterity saving throw or have the Prone condition.</p>

            <h3>Strong Wind</h3>
            <div className="compendium-divider"></div>
            <p>Strong wind imposes Disadvantage on ranged attack
                rolls with weapons. It also extinguishes open
                flames and disperses fog. A flying creature in a
                strong wind must land at the end of its turn or fall.</p>
            <p>A strong wind in a desert can create a sandstorm
                that imposes Disadvantage on Wisdom (Perception) checks.</p>

            <h3>Thin Ice</h3>
            <div className="compendium-divider"></div>
            <p>Thin ice has a weight tolerance of 3d10 × 10 pounds
