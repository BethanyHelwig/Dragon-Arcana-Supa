export default function AnimalsOverview(){
    return (
        <>
            ...
            <p>An animal has a stat block that contains the rules
                necessary to use it in the game. Stat blocks are divided
                into the following parts:</p>
            <p><strong>Name and General Details.</strong> The name of the animal
            ...
            <p><strong>Ability Scores.</strong> An animal’s ability scores, ability
                modifiers, and saving throws are listed here.</p>
            <p><strong>Other Details.</strong> The animal’s Senses, Languages,
                and CR entries appear here. Additional details appear
                in some animals, such as skill proficiencies,
                Resistances, Immunities, and Gear. If an animal
                lacks those details, entries for them don’t appear.</p>
            <p><strong>Traits.</strong> Animal characteristics that are active at all
                times or during certain situations appear here.</p>
            <p><strong>Actions.</strong> The animal can take the actions here in
                addition to those in “Playing the Game.”</p>
            <p><strong>Bonus Actions.</strong> This section provides an animal’s
            ...
            <p>An animal is Tiny, Small, Medium, Large, Huge,
            ...
            <h3>Alignment</h3>
            <div className="compendium-divider"></div>
            <p>The alignment specified in an animal’s stat block is
                a default suggestion of how to roleplay the animal,
                inspired by its traditional role in the game or realworld
                folklore. Change an animal’s alignment to
            ...
            <h3>Armor Class</h3>
            <div className="compendium-divider"></div>
            <p>An animal’s Armor Class (AC) includes its natural
                armor, Dexterity, gear, and other defenses. See
                “Playing the Game” for information on Armor Class.</p>

            <h3>Initiative</h3>
            <div className="compendium-divider"></div>
            <p>The Initiative entry specifies the animal’s Initiative
                modifier followed by the animal’s Initiative
                score in parentheses. Use the modifier when you
                roll to determine an animal’s Initiative. An animal’s
                Initiative modifier is typically equal to its Dexterity
                modifier, but some animals have additional modifiers,
                such as Proficiency Bonus, applied to that number.</p>
            <p>If you don’t want to roll an animal’s Initiative, use
                the Initiative score as the animal’s Initiative in
                combat. Initiative is further detailed in “Playing the Game.”</p>

            <h3>Hit Points</h3>
            <div className="compendium-divider"></div>
            <p>An animal’s Hit Points are presented as a number
                followed by parentheses, where the animal’s Hit
                Point Dice are provided, along with any contribution
                from its Constitution. Either use the number for
                the animal’s Hit Points or roll the die expression in
                parentheses to determine the animal’s Hit Points
                randomly; don’t use both.</p>
            <p>An animal’s size typically determines the die used
            ...
            <p>An animal’s Constitution modifier is multiplied by
                the number of Hit Dice it possesses, and the result
                is added to its Hit Points. For example, if an animal
            ...
            <h3>Speed</h3>
            <div className="compendium-divider"></div>
            <p>The Speed entry specifies an animal’s Speed. Some
                animals have one or more of the following speeds:
                Burrow, Climb, Fly, Swim. Rules for Speed and these
                specials speeds appear in “Rules Glossary.”</p>

            <h3>Ability Scores</h3>
            <div className="compendium-divider"></div>
            <p>Every animal has six ability scores along with
            ...
            <h3>Skills</h3>
            <div className="compendium-divider"></div>
            <p>The Skills entry specifies an animal’s skill proficiencies,
                if any. For example, an animal that is very
                perceptive and stealthy might have bonuses to Wisdom
                (Perception) and Dexterity (Stealth) checks. A
                skill bonus is the sum of an animal’s relevant ability
                modifier and its Proficiency Bonus. Other modifiers
                might apply.</p>
            
            <h3>Resistances and Vulnerabilities</h3>
            <div className="compendium-divider"></div>
            <p>These entries list an animal’s Resistances and Vulnerabilities,
                if any. See “Playing the Game” for more information.</p>

            <div className="compendium-content-emphasis">
                <h3>Running an animal</h3>
                <p>To ensure an animal acts in accordance with its
                    Challenge Rating, follow these rules during combat:</p>
                <p><strong>Special Abilities.</strong> If the animal has a special ability
                    ...
                    often as possible.</p>
                <p><strong>Multiattack.</strong> If the animal has Multiattack, have
                ...
                <p><strong>Bonus Actions, Reactions, Legendary Actions.</strong> If
                    the animal has Bonus Actions, Reactions, or
            ...
            <h3>Immunities</h3>
            <div className="compendium-divider"></div>
            <p>This entry lists the animal’s Immunities, if any. If
                the animal has damage and condition Immunities,
                the damage types are listed before the conditions.
                See “Playing the Game” for details.</p>

            <h3>Gear</h3>
            <div className="compendium-divider"></div>
            <p>animals have proficiency with their equipment. If
                an animal has equipment that can be given away or
                retrieved, the items are listed in the Gear entry. The
                animal’s stat block might include special flourishes
                that happen when the animal uses an item,
            ...
            <p>The Gear entry doesn’t necessarily list all of an
                animal’s equipment. For example, an animal that
            ...
            <p>Equipment mentioned outside the Gear entry is
                ...
                and it is unusable when the animal is defeated.</p>
            <h4>Ammunition and Ranged Attacks</h4>
            <p>An animal that requires ammunition to make
                ranged attacks carries the necessary ammunition.</p>
            <h4>Equipping an animal with Other Items</h4>
            <p>You may equip animals with additional gear however
                you like, using the items in “Equipment” for
                inspiration. You decide how much of an animal’s
                equipment is recoverable after the creature is slain
                and whether any of that equipment is still usable.</p>
            <p>Beware of giving an animal combat-oriented
                magic items, since those might alter the animal’s
                Challenge Rating. If you do give an animal a magic
                item, the animal can have Attunement with magic
                items as noted in “Equipment.” An animal with
                a class tag after its creature type is considered a
                member of that class for Attunement purposes.</p>

            <h3>Senses</h3>
            <div className="compendium-divider"></div>
            <p>The Senses entry specifies an animal’s Passive
                Perception score, as well as any special senses the
                animal possesses. Passive Perception and special
                senses are described in “Rules Glossary.”</p>

            <h3>Languages</h3>
            <div className="compendium-divider"></div>
            <p>This entry lists languages that the animal can use
                to communicate. Sometimes an animal can understand
            ...
            <p>The number of Experience Points (XP) an animal
                is worth is based on its CR, as detailed in the Experience
                Points by Challenge Rating table. XP is
                awarded for defeating the animal in combat or
                otherwise neutralizing it.</p>
            <p>Unless a rule says otherwise, an animal summoned
            ...
            <p>An animal’s Proficiency Bonus (PB) is determined
                by its CR, as shown in the Proficiency Bonus by
                Challenge Rating table, and is reflected in saving
                throws, skills, and other statistics where the animal’s
            ...
            <h3>Traits</h3>
            <div className="compendium-divider"></div>
            <p>An animal’s traits, if any, are features that are active
                at all times or in certain situations.</p>
            
            <h3>Actions</h3>
            <div className="compendium-divider"></div>
            <p>An animal can take the actions in this section or
                take one of the actions available to all creatures, as
                described in “Playing the Game.”</p>
            <h4>Attack Notation</h4>
            <p>The entry for an animal’s attack identifies whether
            ...
            <h4>Spellcasting</h4>
            <p>If an animal can cast any spells, its stat block lists
                the spells and provides the animal’s spellcasting
            ...
            <p>An animal’s spell can have special rules or restrictions.
            ...
            <p><strong>Spell Components.</strong> The Spellcasting trait notes
                whether the animal’s spellcasting ignores the
                need for certain spell components. If any spell components
                are required, describe the animal’s use of
                Verbal, Somatic, or Material components to signal to
                characters that it is casting a spell. An animal that
            ...
            <p><strong>X/Day.</strong> This notation means the stat block part can
                ...
                by X) and that an animal must finish a Long Rest
                to regain expended uses. For example, a Reaction
                that includes “1/Day” means the Reaction can be
                taken once and that the animal must finish a
                Long Rest to take it again.</p>
            <p><strong>Recharge X–Y.</strong> This notation means an animal
                can use the stat block part once. At the start of
                each of the animal’s turns, roll 1d6. If the roll
                is within the number range given in the notation
                (represented by X–Y), the animal regains the use
                of that part, which also recharges when the animal
                finishes a Short or Long Rest. For example,
                “Recharge 5–6” in an action means an animal can
                take the action once. Then, at the start of each of
                the animal’s turns, it regains the use of that action
                if it rolls a 5 or 6 on 1d6.</p>
            <p><strong>Recharge after a Short or Long Rest.</strong> This notation
                means the animal can use the stat block
