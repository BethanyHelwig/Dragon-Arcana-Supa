export default function CastingSpells(){
    return(
        <div>
            <h2>Casting Spells</h2>
            <p>Each spell description has a series of entries that
                provide the details needed to cast the spell. The following
                sections explain each of those entries, which
                follow a spell’s name.</p>

            <div className="compendium-content-emphasis">
                <h3>Casting in Armor</h3>
                <p>You must have training with any armor you are wearing
                    to cast spells while wearing it. You are otherwise
                    too hampered by the armor for spellcasting.</p>
            </div>

            <h3>Spell Level</h3>
            <div className="compendium-divider"></div>
            <p>Every spell has a level from 0 to 9, which is indicated
                ...
                members gain access to spells of certain levels.</p>
            <h4>Spell Slots</h4>
            <p>Spellcasting is taxing, so a spellcaster can cast only
                ...
                has four level 1 spell slots and two level 2 slots.</p>
            <p>When you cast a spell, you expend a slot of that
                spell’s level or higher, effectively “filling” a slot with
                the spell. Imagine a spell slot is a groove of a certain
                size—small for a level 1 slot and larger for a higher-
                level spell. A level 1 spell fits into a slot of any
                ...
                four level 1 slots and has three remaining.</p>
            <p>Finishing a Long Rest restores any expended spell slots.</p>
            <h4>Casting without Slots</h4>
            <p>There are several ways to cast a spell without expending a spell slot:</p>
            <p><strong>Cantrips.</strong> A cantrip is cast without a spell slot.</p>
            <p><strong>Rituals.</strong> Certain spells have the Ritual tag in the
                ...
                a spellcaster must have it prepared.</p>
            <p><strong>Special Abilities.</strong> Some characters and monsters
                ...
                cast the spell a limited number of times per day.</p>
            <p><strong>Magic Items.</strong> Spell Scrolls and some other magic
                items contain spells that can be cast without a
                spell slot. The description of such an item specifies
                how many times a spell can be cast from it.</p>
            <h4>Using a Higher-Level Spell Slot</h4>
            <p>When a spellcaster casts a spell using a slot that is
            ...
            <p>Some spells, such as Magic Missile and Cure
                Wounds, have more powerful effects when cast at a
                higher level, as detailed in a spell’s description.</p>

            <h3>School of Magic</h3>
            <div className="compendium-divider"></div>
            <p>Each spell belongs to a school of magic. The schools
                are listed in the Schools of Magic table. These categories
                help describe spells but have no rules of their
                own, although some other rules refer to them.</p>
            <h4>Schools of Magic</h4>
            <table className="table">
                <thead>
                    <tr>
                        <th scope="col">School</th>
                        <th scope="col">Typical Effects</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <div className="compendium-divider"></div>
            <p>If a spell is on a class’s spell list, the class’s name
                ...
                class in the parentheses.</p>

            <h3>Casting Time</h3>
            <div className="compendium-divider"></div>
            <p>Most spells require the Magic action to cast, but
                some spells require a Bonus Action, a Reaction, or 1
                minute or more. A spell’s Casting Time entry specifies
                which of those is required.</p>
            <h4>One Spell with a Spell Slot per Turn</h4>
            <p>On a turn, you can expend only one spell slot to cast
                a spell. This rule means you can’t, for example, cast
                a spell with a spell slot using the Magic action and
                another one using a Bonus Action on the same turn.</p>
            <h4>Reaction and Bonus Action Triggers</h4>
            <p>A spell that has a casting time of a Reaction is cast
                ...
                trigger defined in the spell.</p>
            <h4>Longer Casting Times</h4>
            <p>Certain spells—including a spell cast as a Ritual—
                require more time to cast: minutes or even
            ...
            <h3>Range</h3>
            <div className="compendium-divider"></div>
            <p>A spell’s range indicates how far from the spellcaster
                the spell’s effect can originate, and the spell’s
                description specifies which part of the effect is limited
                by the range. A range usually takes one of the following forms:</p>
            <p><strong>Distance.</strong> The range is expressed in feet.</p>
            <p><strong>Touch.</strong> The spell’s effect originates on something,
                as defined by the spell, that the spellcaster must
                touch within their reach.</p>
            <p><strong>Self.</strong> The spell is cast on the spellcaster or emanates
                from them, as specified in the spell.</p>
            <p>If a spell has movable effects, they aren’t restricted
                by its range unless the spell’s description says otherwise.</p>

            <h3>Components</h3>
            <div className="compendium-divider"></div>
            <p>A spell’s components are physical requirements the
                ...
                components, the spellcaster can’t cast the spell.</p>
            <h4>Verbal (V)</h4>
            <p>A Verbal component is the chanting of esoteric
                ...
                spell with a Verbal component.</p>
            <h4>Somatic (S)</h4>
            <p>A Somatic component is a forceful gesticulation
                or an intricate set of gestures. A spellcaster must
                use at least one of their hands to perform these movements.</p>
            <h4>Material (M)</h4>
            <p>A Material component is a particular material used
                in a spell’s casting, as specified in parentheses in
                the Components entry. These materials aren’t consumed
                by the spell unless the spell’s description
                states otherwise. The spellcaster must have a hand
                free to access them, but it can be the same hand
                used to perform Somatic components, if any.</p>
            <p>If a spell doesn’t consume its materials and
                ...
                (see “Equipment” for descriptions).</p>

            <h3>Duration</h3>
            <div className="compendium-divider"></div>
            <p>A spell’s duration is the length of time the spell persists
                after it is cast. A duration typically takes one of
                the following forms:</p>
            <p><strong>Concentration.</strong> A duration that requires Concentration
                follows the Concentration rules (see “Rules Glossary”).</p>
            <p><strong>Instantaneous.</strong> An instantaneous duration means
                the spell’s magic appears only for a moment and then disappears.</p>
            <p><strong>Time Span.</strong> A duration that provides a time span
                ...
                (no action required) if you don’t have the Incapacitated condition.</p>

            <h3>Effects</h3>
            <div className="compendium-divider"></div>
            <p>The effects of a spell are detailed after its duration
                entry. Those details present exactly what the
                ...
                three, each of which is detailed below.</p>
            <h4>Targets</h4>
            <p>A typical spell requires the caster to pick one or
                more targets to be affected by the spell’s magic. A
                spell’s description says whether the spell targets
                creatures, objects, or something else.</p>
            <p><strong>A Clear Path to the Target.</strong> To target something
                with a spell, a caster must have a clear path to it, so
                it can’t be behind Total Cover.</p>
            <p><strong>Targeting Yourself.</strong> If a spell targets a creature
                of your choice, you can choose yourself unless the
                creature must be Hostile or specifically a creature other than you.</p>
            <p><strong>Areas of Effect.</strong> Some spells, such as Thunderwave,
                ...
                Emanation, Line, or Sphere.</p>
            <p><strong>Awareness of Being Targeted.</strong> Unless a spell has
            ...
            <p><strong>Invalid Targets.</strong> If you cast a spell on someone
                or something that can’t be affected by it, nothing
                happens to that target, but if you used a spell slot to
                cast the spell, the slot is still expended.</p>
            <p>If the spell normally has no effect on a target that
                ...
                that the spell did nothing to the target.</p>
            <h4>Saving Throws</h4>
            <p>Many spells specify that a target makes a saving
                ...
                Here’s how to calculate the DC for your spells:</p>
            <p><strong>Spell save DC</strong> = 8 + your spellcasting ability modifier + your Proficiency Bonus</p>
            <h4>Attack Rolls</h4>
            <p>Some spells require the caster to make an attack
                roll to determine whether the spell hits a target.
                Here’s how to calculate the attack modifier for your spells:</p>
            <p><strong>Spell attack modifier</strong> = your spellcasting ability modifier + your Proficiency Bonus</p>
            <h4>Combining Spell Effects</h4>
            <p>The effects of different spells add together while
                ...
                continues until the duration of the second Bless ends.</p>
            <div className="compendium-content-emphasis">
                <h3>Identifying an Ongoing Spell</h3>
                <p>You can try to identify a non-instantaneous spell by
                    its observable effects if its duration is ongoing. To
                    identify it, you must take the Study action and succeed
                    on a DC 15 Intelligence (Arcana) check.</p>
            </div>
        </div>
    )
}